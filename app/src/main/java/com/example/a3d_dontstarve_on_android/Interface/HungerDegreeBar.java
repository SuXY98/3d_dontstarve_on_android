...
public class HungerDegreeBar {
    private static final int POSITION_COMPONENT_COUNT = 3;
    private final ByteBuffer indexArray;
    private final VertexAarray vertexAarray;
    private float color[] = {0.1f, 0.7f, 0.1f, 1.0f};
    private InterfaceShaderProgram mProgram;

    public HungerDegreeBar(Context context) {
    ...
    public void draw(float[] mvpMatrix, int hungerDegreeLeft) {
        mProgram.useProgram();
        ...
        vertexAarray.setVertexAttribPointer(0,
                mProgram.getVertexAttrLocation(),
                POSITION_COMPONENT_COUNT, 0);
        glDrawElements(GLES20.GL_TRIANGLES, 18*hungerDegreeLeft, GL_UNSIGNED_BYTE, indexArray);
    }
}
