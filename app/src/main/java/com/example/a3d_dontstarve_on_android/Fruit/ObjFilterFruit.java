...
public class ObjFilterFruit extends AFilter {
    ...
    private int mHKd;
    private int mHKs;
    private Obj3DFruit obj;

    private int textureId;

    public ObjFilterFruit(Resources mRes) {
        super(mRes);
    }

    public void setObj3D(Obj3DFruit obj){
        this.obj=obj;
    }
    ...
    protected void onCreate() {
        createProgramByAssetsFile("character/obj2.vert","character/obj2.frag");
        ...
        if(obj!=null&&obj.mtl!=null){
            try {
                Log.e("obj","texture-->"+"fruit/"+obj.mtl.map_Kd);
                textureId=createTexture(BitmapFactory.decodeStream(mRes.getAssets().open("fruit/"+obj.mtl.map_Kd)));
