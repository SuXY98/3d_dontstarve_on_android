...
public class ObjReaderFruit {

    public static void read(InputStream stream, Obj3DFruit obj3D){
    ...
    public static List<Obj3DFruit> readMultiObj(Context context, String file){
        boolean isAssets;
        ArrayList<Obj3DFruit> data=new ArrayList<>();
        ...
        HashMap<String,Obj3DFruit> mObjs=new HashMap<>();
        Obj3DFruit nowObj=null;
        MtlInfo nowMtl=null;
        try{
            String parent;
        ...
        for (Map.Entry<String, Obj3DFruit> stringObj3DEntry : mObjs.entrySet()) {
            Obj3DFruit obj = stringObj3DEntry.getValue();
            data.add(obj);
            obj.dataLock();
        }
        return data;
